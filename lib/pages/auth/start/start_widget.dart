                  ...
                  children: [
                    Align(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/Start_Page_Adventure_Picture.jpeg',
                                          ...
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '4iq7slee' /* Your guide to discovering the ... */,
                                              ),
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'b3rg1k23' /* Your guide to discovering the ... */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .titleMedium
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'gf0cozt6' /* Your guide to discovering the ... */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .titleMedium
