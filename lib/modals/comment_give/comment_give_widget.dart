...
import 'comment_give_model.dart';
export 'comment_give_model.dart';

class CommentGiveWidget extends StatefulWidget {
  const CommentGiveWidget({
    super.key,
  ...
  @override
  State<CommentGiveWidget> createState() => _CommentGiveWidgetState();
}

class _CommentGiveWidgetState extends State<CommentGiveWidget> {
  late CommentGiveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentGiveModel());
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'j2v4qpw3' /* Some text like: Great project!... */,
                                ),
                        ...
                        onPressed: () async {
                          ...
                          await widget!.product!.reference.update({
                            ...createProductRecordData(
                              productInformation: createProjectStruct(
                                fieldValues: {
